 ...
 * PROCESS-VM-READV
*/
static inline int sreadv(pid_t pid, const struct iovec *local_iov, unsigned long liovcnt, 
              const struct iovec *remote_iov, unsigned long riovcnt, unsigned long flags)
{
	return syscall(__NR_sys_process_vm_readv, pid, local_iov, liovcnt, remote_iov, riovcnt, flags);
}

/**
 * PROCESS-VM-WRITEV
*/
static inline int swritev(pid_t pid, const struct iovec *local_iov, unsigned long liovcnt, 
              const struct iovec *remote_iov, unsigned long riovcnt, unsigned long flags)
{
	return syscall(__NR_sys_process_vm_writev, pid, local_iov, liovcnt, remote_iov, riovcnt, flags);
}
